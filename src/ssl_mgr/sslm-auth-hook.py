...
env variables passed down:
 ...
 $CERTBOT_VALIDATION
    validation string (for HTTP-01 DNS-01)

 $CERTBOT_TOKEN
    resource filename requested if HTTP-01 challenge

 $CERTBOT_REMAINING_CHALLENGES
    number of challenges that remain after the current one,
...
Info includes server names and, if needed, how to restart
web server and push dns out
"""
