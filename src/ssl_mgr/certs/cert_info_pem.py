...
for each component
"""
from .cert_info import key_pem_info, csr_pem_info, cert_pem_info

def _extract_label(line):
    """
    Takes: -----BEGIN [LABEL]-----
...
def cert_split_pem_string(pemstring:str):
    """
...
def cert_info_from_pem_string(pemstring:str):
    """
    Certificate pem files are often concatenated.
    chain.pem for example contains multiple certs.
    Separate the components and return cert info for each
